...
const barService = {
   ...
   async updateBar(barId, { name, address, time, tel, x, y, newImageNames }) {
      ...
      const isSame = targetKeys.every((key) => foundBar[key] === newBar[key]) && targetKeys.length === Object.keys(foundBar).length;
